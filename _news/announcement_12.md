...
Accelerating engineering with artificial intelligence: Driving faster design and optimization with limited data
...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/Secondment_02.jpg" title="example image" class="img-fluid rounded z-depth-1" %}
    </div>
</div>

<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/Secondment_03.jpg" title="example image" class="img-fluid rounded z-depth-1" %}
    </div>
</div>

<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/Secondment_01.jpg" title="example image" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/Secondment_04.jpg" title="example image" class="img-fluid rounded z-depth-1" %}
    </div>
</div>